...
from espnet2.asr.ntm.ntm_cell import NTMCell

from espnet2.asr.dnc.sam import SAM
from espnet2.asr.dnc.dnc import DNC
...
sam_choices = ClassChoices(
    "sam",
    classes=dict(sam=DNC),
    type_check=DNC,
    default=None,
    optional=True,
)

ntm_choices = ClassChoices(
    "ntm",
    classes=dict(ntm=NTMCell),
    type_check=AbsNTM,
    default=None,
    optional=True,
)
...
class ASRTask(AbsTask):
    ...
    def build_model(cls, args: argparse.Namespace) -> ESPnetASRModel:
        ...
        # 4.1. NTM
        if args.ntm is not None:
            ntm_class = ntm_choices.get_class(args.ntm)
            ntm = ntm_class(
